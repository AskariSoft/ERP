...
namespace ERP.BLL.IN
{
    public class IN_TI
    {
        ...
        public int Save_Master(string vInv_SqNo, string vTr_No, DateTime vTr_Date, int vE_ID, string vRef1, int vTrLevel, List<DataRow> lst_Items,
                                string Doc_Inv_Sqno,string Doc_Tr_No,
                                int vBranch_ID, int vDept_ID_Store, int vComp_ID, int vU_S, string vU_Name, int vIsUpdate, double vAmt_Item)
        {
            database1 clsdatabase1 = new database1();
            SqlCommand SCmd = new SqlCommand();
            ...
            try
            {
                ...
                //SCmd.Parameters.Add(new SqlParameter("@nDoc_Inv_SqNo", SqlDbType.Int, 4, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Default, Convert.ToInt32 (Doc_Inv_Sqno)));
                SCmd.Parameters.Add(new SqlParameter("@sDoc_Tr_No", SqlDbType.VarChar, 30, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, Doc_Tr_No));
                ...
                strRecAffected = clsdatabase1.Exec_Int_Multi("stpInv_Tr_Transfer_In", SCmd, sqlcon, Tran);
                strErrorCode = clsdatabase1.sErrorCode.Trim();
                ...
                if (nRet_Val == 1)
                {
                    ...
                    for (int i = 0; i < lst_Items.Count; i++)
                    {
                        ...
                        SCmd.Parameters.Add(new SqlParameter("@nR_Qty", SqlDbType.Decimal, 3, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, lst_Items.ElementAt(i)["R_Qty"].ToString()));
                        SCmd.Parameters.Add(new SqlParameter("@nR_Rate", SqlDbType.Decimal, 2, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, lst_Items.ElementAt(i)["R_Rate"].ToString()));
                        SCmd.Parameters.Add(new SqlParameter("@dTr_Date", SqlDbType.DateTime, 10, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Default, vTr_Date));
                        SCmd.Parameters.Add(new SqlParameter("@nDept_ID_Store", SqlDbType.Int, 4, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Default, vDept_ID_Store));
                        //SCmd.Parameters.Add(new SqlParameter("@nDoc_Inv_SqNo", SqlDbType.Int, 4, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Default, Doc_Inv_Sqno));
                        SCmd.Parameters.Add(new SqlParameter("@sDoc_Tr_No", SqlDbType.VarChar, 30, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, Doc_Tr_No));
                     ...
                     string vRef4, int vFY_ID, int vU_S, string vU_Name, int vComp_ID)
        {
            ...
            clsdatabase1.Exec_Int_SP_S("stpInv_Tr_Transfer_In", SCmd);
            strErrorCode = clsdatabase1.sErrorCode.Trim();
        ...
        public int Save_Rollback(int vInv_SqNo, string vFYS_Date, string vFYE_Date, int vDept_ID_Store, int vTrLevel, int vComp_ID, int vBranch_ID, string vU_Name, int vU_S, string vAuth_D,int vFY_ID)
        {
            ...
            SCmd.Parameters.Add(new SqlParameter("@dFYEDate", SqlDbType.DateTime, 8, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Default, vFYE_Date));
            SCmd.Parameters.Add(new SqlParameter("@nFY_ID", SqlDbType.Int, 4, ParameterDirection.Input, false, 18, 1, "", DataRowVersion.Proposed, vFY_ID));
            ...
            database1 clsdatabase1 = new database1();
            clsdatabase1.Exec_Int_SP("stpInv_Tr_Transfer_In", SCmd);
            strErrorCode = clsdatabase1.sErrorCode.Trim();
            nRet_Val = Convert.ToInt32(SCmd.Parameters["@nRetValue"].Value);
            try
            {
